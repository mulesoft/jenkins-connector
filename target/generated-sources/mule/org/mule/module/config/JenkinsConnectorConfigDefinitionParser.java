...
public class JenkinsConnectorConfigDefinitionParser
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(JenkinsConnectorConnectionManager.class.getName());
        builder.setScope(BeanDefinition.SCOPE_SINGLETON);
        setInitMethodIfNeeded(builder, JenkinsConnectorConnectionManager.class);
        setDestroyMethodIfNeeded(builder, JenkinsConnectorConnectionManager.class);
