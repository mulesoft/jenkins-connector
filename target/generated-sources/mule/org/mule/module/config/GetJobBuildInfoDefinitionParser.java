...
import org.mule.module.processors.GetJobBuildInfoMessageProcessor;
...
public class GetJobBuildInfoDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetJobBuildInfoMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "jobName", "jobName");
        parseProperty(builder, element, "buildNumber", "buildNumber");
