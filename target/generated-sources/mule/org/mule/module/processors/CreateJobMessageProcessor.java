...
/**
 * CreateJobMessageProcessor invokes the {@link org.mule.module.JenkinsConnector#createJob(java.lang.String)} method in {@link JenkinsConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedJobName = ((String) evaluateAndTransform(getMuleContext(), event, CreateJobMessageProcessor.class.getDeclaredField("_jobNameType").getGenericType(), null, jobName));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((JenkinsConnector) object).createJob(_transformedJobName);
                }
