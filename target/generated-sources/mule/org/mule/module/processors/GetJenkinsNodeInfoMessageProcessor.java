...
/**
 * GetJenkinsNodeInfoMessageProcessor invokes the {@link org.mule.module.JenkinsConnector#getJenkinsNodeInfo()} method in {@link JenkinsConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.3.2", date = "2013-03-22T10:39:58-03:00", comments = "Build UNNAMED.1372.db235f3")
public class GetJenkinsNodeInfoMessageProcessor
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((JenkinsConnector) object).getJenkinsNodeInfo();
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getJenkinsNodeInfo"), event, e);
        }
    }
