    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedJobName = ((String) evaluateAndTransform(getMuleContext(), event, BuildMessageProcessor.class.getDeclaredField("_jobNameType").getGenericType(), null, jobName));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((JenkinsConnector) object).build(_transformedJobName);
                    return null;
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("build"), event, e);
        }
    }
